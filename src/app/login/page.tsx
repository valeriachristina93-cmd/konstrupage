    ...
    <div className="flex items-center justify-center min-h-screen bg-secondary">
      <Card className="w-full max-w-md mx-4 shadow-2xl">
        <CardHeader className="text-center">
          <h1 className="text-5xl font-bold font-headline bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">Stallo</h1>
          <CardDescription className="pt-2">Crie presell pages em minutos.</CardDescription>
        </CardHeader>
        <CardContent>
