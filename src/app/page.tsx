...
import { Check, Sparkles, Star, MessageSquare, Link2, Shield, Palette, PlayCircle, BarChart, Users, MousePointerClick, Rocket, Ghost, Cookie, Target, Video, Hand, ShieldCheck, Loader2, Globe, CreditCard as CreditCardIcon, ArrowRight, Bot, Phone, UserCheck, Cake, Percent, Settings2, ShoppingCart, CheckCircle, Code, Copy, Quote } from 'lucide-react';
