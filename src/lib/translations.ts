...
export const translations = {
  pt: {
    ...
    facebook_pixel_id: 'ID do Pixel do Facebook (Meta)',
    facebook_pixel_id_placeholder: 'Cole apenas o número de ID do seu Pixel',
    facebook_pixel_id_description: 'Adiciona o código do Pixel que dispara um evento de PageView.',
    google_ads_id: 'ID da Tag do Google (Google Ads)',
    google_ads_id_description: 'Adiciona a tag do Google que dispara um evento de PageView.',
  ...
  en: {
    ...
    tracking: 'Tracking',
    facebook_pixel_id: 'Facebook (Meta) Pixel ID',
    facebook_pixel_id_placeholder: 'Paste only your Pixel ID number',
    facebook_pixel_id_description: 'Adds the Pixel code that fires a PageView event.',
    google_ads_id: 'Google Tag ID (Google Ads)',
    google_ads_id_description: 'Adds the Google tag that fires a PageView event.',
  ...
  es: {
    ...
    facebook_pixel_id: 'ID del Píxel de Facebook (Meta)',
    facebook_pixel_id_placeholder: 'Pega solo el número de ID de tu Píxel',
    facebook_pixel_id_description: 'Añade el código del Píxel que dispara un evento PageView.',
    google_ads_id: 'ID de Etiqueta de Google (Google Ads)',
    google_ads_id_description: 'Añade la etiqueta de Google que dispara un evento PageView.',
