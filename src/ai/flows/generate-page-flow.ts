'use server';
/**
 * @fileOverview A Genkit flow for generating a "Super Prompt" for creating sales or review pages.
 *
 * This flow takes product information and generates a detailed prompt that can be used with
 * other AI models like ChatGPT, Gemini, or Claude to create high-quality page content.
 */
